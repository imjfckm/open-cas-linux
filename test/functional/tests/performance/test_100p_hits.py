...
from core.performance import WorkloadParameter
...
def test_4k_100p_hit_reads_wt(queue_depth, numjobs, cache_line_size, perf_collector, request):
    """
        ...
        decription: |
          Characterize cache device with workload (parametrized by qd and jub number), and then run
